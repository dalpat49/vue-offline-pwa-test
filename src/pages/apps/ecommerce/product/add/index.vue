...
const activeShippingType = ref(shippingList[0].value)
const activeGlobalDeliveryType = ref('Worldwide delivery')
                ...
                >
                  ...
                  <VWindowItem value="Global Delivery">
                    <div class="ps-3">
                      ...
                      <VRadioGroup
                        v-model="activeGlobalDeliveryType"
                        class="ms-1"
                      >
                        <VRadio
